...
var $author$project$Main$init = {drag: $elm$core$Maybe$Nothing, nextId: 0, placed: _List_Nil, rotation: 0, selectedKind: $elm$core$Maybe$Nothing, selectedPlaced: $elm$core$Maybe$Nothing};
			...
			_List_fromArray(
				[
					...
					A3(
						...
						$author$project$Main$DragMouseMove,
...
var $author$project$Main$boardCols = 34;
var $author$project$Main$boardRows = 22;
...
var $author$project$Main$background = A2(
	...
	_List_fromArray(
		[
			...
			$elm$core$String$fromInt($author$project$Main$boardCols * $author$project$Main$u)),
			$elm$svg$Svg$Attributes$height(
			$elm$core$String$fromInt($author$project$Main$boardRows * $author$project$Main$u)),
...
var $author$project$Main$gridLines = function () {
	...
	return _Utils_ap(
		A2(
			$elm$core$List$map,
			vLine,
			A2($elm$core$List$range, 0, $author$project$Main$boardCols)),
		A2(
			$elm$core$List$map,
			hLine,
			A2($elm$core$List$range, 0, $author$project$Main$boardRows)));
}();
var $elm$svg$Svg$svg = $elm$svg$Svg$trustedNode('svg');
var $elm$svg$Svg$Attributes$viewBox = _VirtualDom_attribute('viewBox');
var $author$project$Main$viewBoard = function (model) {
	var w = $author$project$Main$boardCols * $author$project$Main$u;
	var h = $author$project$Main$boardRows * $author$project$Main$u;
	return A2(
		$elm$svg$Svg$svg,
		_List_fromArray(
			[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2(
					$elm$core$List$map,
					$author$project$Main$paletteEntry(model),
					$author$project$Main$allSpecs)),
				A2(
				$elm$html$Html$h3,
				_List_Nil,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Main$RotateMsg)
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Main$DeleteMsg)
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Main$ClearMsg)
							]),
						_List_fromArray(
							[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Pick a tile on the right, then click on the board to place a copy. Click a placed tile to select it (orange outline); drag it to move; Rotate turns by 90°; Delete removes it.')
					])),
				A2(
				$elm$html$Html$p,
				_List_fromArray(
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						'Next placement rotation: ' + ($elm$core$String$fromInt(model.rotation * 90) + ('°  ·  Placed: ' + $elm$core$String$fromInt(
							$elm$core$List$length(model.placed)))))
					]))
			]));
};
